...
extension WebSocketClientTests: WebSocketClient.Delegate {
    ...
    func webSocketClient(_: WebSocketClient, didReceive event: WebSocketClient.Event) {
        print("WebSocket received event: \(event.debugDescription)")
    }

    /// WebSocket output log
    func webSocketClient(_: WebSocketClient, didOutput log: WebSocketClient.Log) {
    ...
    func webSocketClient(_: WebSocketClient, didMonitorNetworkPathChange path: NWPath) {
        print("WebSocket did monitor network path change: \(path)")
    }
